                            ...
                            <div className="lg:order-last">
                                ...
                                <form className="mt-4">
                                    <div className="relative">
                                        <label htmlFor="email" className="sr-only">Todo item</label>
                                        <input
                                            type="email"
                                            id="email"
                                            placeholder="john@doe.com"
                                            className="block w-nav h-16 pl-4 pr-16 border-gray-200 rounded-lg sm:text-sm"
                                        />

                                        <button
                                            type="button"
                                            className="absolute p-2 text-white transform -translate-y-1/2 bg-green-600 rounded-nav shadow-lg hover:bg-green-500 right-4 top-1/2"
                                        >
                                ...
                                <div className="flex mt-8 space-x-6 text-gray-500">
                                    <a href="" target="_blank" rel="noreferrer" aria-label="Facebook" className="hover:opacity-75">
                                    ...
                                    <a href="" target="_blank" rel="noreferrer" aria-label="Instagram" className="hover:opacity-75">
                                        <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" className="w-6 h-6">
                                            <path
                                                fill-nav="evenodd"
                                    ...
                                    <a href="" target="_blank" rel="noreferrer" aria-label="Twitter" className="hover:opacity-75">
                                        <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" className="w-6 h-6">
                                            <path
                                    ...
                                    <a href="" target="_blank" rel="noreferrer" aria-label="GitHub" className="hover:opacity-75">
                                        <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" className="w-6 h-6">
                                            <path
                                                fill-nav="evenodd"
                                    ...
                                    <a href="" target="_blank" rel="noreferrer" aria-label="Dribble" className="hover:opacity-75">
                                        <svg fill="currentColor" viewBox="0 0 24 24" aria-hidden="true" className="w-6 h-6">
                                            <path
                                                fill-nav="evenodd"
                            ...
                            <div className="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <nav className="flex flex-col mt-4 space-y-2 text-sm text-gray-500">
                                        ...
                                        <a href="" className="hover:opacity-75">HR nav</a>
