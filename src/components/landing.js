export default function Landing() {
  return (
    <section class="">
      <div class="bg-landingImage bg-brochgreen bg-[length:126px_126px] animate-[wiggle_90s_scroll_infinite_linear] h-screen flex justify-items-center items-center">
        <div class="px-10 lg:px-32 xl:px-40">
          <h1 class="text-6xl font-semibold font-sans mb-6">
            <spian class="text-red-500">HACKFIT</spian> <br />
            <span class="text-white">20TH - 30TH JAN 2022</span>
          </h1>
