...
export default class Prize extends Component {
  render() {
    return (
      <section className="z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
          ...
          <div className="transform w-full  bg-brochblack rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row transition duration-500 hover:scale-105">
            <div className="w-full h-80">
              ...
              <p className="text-center text-white font-bold text-5xl p-2">
                10000 <span className="text-green-600">$</span>
              </p>
              <p className="text-center text-yellow-400 font-bold text-2xl">
                1st prize
              </p>
            </div>
          </div>
