...
export default class Prize extends Component {
  render() {
    return (
      <section className="bg-brochgreen mx-auto sm:px-6 lg:px-4  px-4 py-12">
      <div className="text-center pb-12">
        <h1 className="font-bold mb-10 text-5xl md:text-5xl lg:text-7xl sm:text-6xl font-heading text-white">
          prizes
        </h1>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-9">
        <div className="transform w-full  bg-brochblack rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row transition duration-500 hover:scale-105">
          <div className="w-full h-80">
            <img
              className="object-center md:ml-36 ml-24 p-3 object-cover w-40"
              src="../gold-cup.gif"
              alt="placholder"
            ></img>
