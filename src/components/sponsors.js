  ...
  return (
    <section>
      <div className="bg-brochgreen text-white py-8">
        ...
        <h2 className="mx-6 mt-1 font-pixe text-center text-gray-500 text-5xl md:text-6xl sm:text-6xl sm:text-center sm:mx-0">
          Diamond Sponsors
        </h2>
        ...
        <div className="w-full bg-brochgreen">
          <section className="max-w-md mx-auto px-4 py-12">
            <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-1 gap-5">
