...
const linkedin_svg = <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
  width="48" height="48"
...
const twitter_svg = <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
  width="48" height="48"
    ...
    <>
      <div className="w-full bg-brochgreen rounded-lg sahdow-lg overflow-hidden flex flex-col md:flex-row ">
        ...
        <div className="w-full md:w-3/5 text-left p-4 md:p-4 space-y-2">
          <p className="text-5xl text-white font-bold pt-4">{props.name}</p>
